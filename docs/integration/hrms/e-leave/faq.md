...
### Why don’t I see an option to add attachments?
...
### Why is my leave auto-approved instantly?
...
### Why can’t I edit certain approved leave applications?
...
### What is the Month-to-Date (MTD) limit formula?
...
### Why doesn’t my MTD calculation match HRMS?
...
### What happens when leave exceeds the MTD limit?
...
### What happens when leave exceeds the Year-to-Date (YTD) limit?
...
### Error: `OOPS! We have encountered some problems... type 'NULL' is not a subtype of type 'String'`
...
### Why doesn’t the HRMS birthday calendar show my team’s birthdays?

The birthday calendar displays only colleagues in the **same branch and department** as the logged-in user.

### Why does the Leave Balance Summary show different taken days versus Manager Approval view?
...
### Why does HRMS show duplicate leave applications while Payroll shows only one?
...
### How to register the staff email to access the E Leave?
...
### How to deregister the staff email to access the E Leave?
