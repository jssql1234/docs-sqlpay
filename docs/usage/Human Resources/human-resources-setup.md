...
title: Setup
description: Setup
slug: /usage/Human_Resources/Setup
tags: ["SQL Payroll", "HR"]
---
...
- [Branch](/usage/Human_Resources/Setup#maintain-branch)
- [Department](/usage/Human_Resources/Setup#maintain-department)
- [Group](/usage/Human_Resources/Setup#maintain-group)
- [Category](/usage/Human_Resources/Setup#maintain-category)
- [Project](/usage/Human_Resources/Setup#maintain-project)
- [Job](/usage/Human_Resources/Setup#maintain-job)
- [Task](/usage/Human_Resources/Setup#maintain-task)
- [Race](/usage/Human_Resources/Setup#maintain-race)
- [History Type](/usage/Human_Resources/Setup#maintain-history-type)
- [Announcement](/usage/Human_Resources/Setup#maintain-announcement)
...
|              | Field Type: Date                    |
| Type         | Definition: Changes [History Type](/usage/Human_Resources/Setup#maintain-history-type)    |
...
| Set as Default | Click This button if wanted the selected Branch Code to be Auto Assign this Branch Code on New at [Maintain Employee](/usage/Human_Resources/Setup#maintain-employee) |
...
| Set as Default | Click This button if wanted the selected Department Code to be Auto Assign this Department Code on New at [Maintain Employee](/usage/Human_Resources/Setup#maintain-employee) |
...
| Set as Default | Click This button if wanted the selected Group Code to be Auto Assign this Group Code on New at [Maintain Employee](/usage/Human_Resources/Setup#maintain-employee) |
...
| Set as Default | Click This button if wanted the selected Category Code to be Auto Assign this Category Code on New at [Maintain Employee](/usage/Human_Resources/Setup#maintain-employee) |
...
| Set as Default | Click This button if wanted the selected Project Code to be Auto Assign this Project Code on New at [Maintain Employee](/usage/Human_Resources/Setup#maintain-employee) |
...
| Set as Default | Click This button if wanted the selected Job Code to be Auto Assign this Job Code on New at [Maintain Employee](/usage/Human_Resources/Setup#maintain-employee) |
...
| Set as Default | Click This button if wanted the selected Task Code to be Auto Assign this Task Code on New at [Maintain Employee](/usage/Human_Resources/Setup#maintain-employee) |
...
| Set as Default | Click This button if wanted the selected Race Code to be Auto Assign this Race Code on New at [Maintain Employee](/usage/Human_Resources/Setup#maintain-employee) |
...
| Set as Default | Click This button if wanted the selected History Type Code to be Auto Assign this History Type Code on New Changes at [Maintain Employee](/usage/Human_Resources/Setup#maintain-employee) |
