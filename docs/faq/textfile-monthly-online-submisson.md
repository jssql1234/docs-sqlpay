...
1. After processed month end, navigate to **Payroll** > **Government Reports**.

2. Click on the following button (**Print EPF Borang A**):

   ![epf-print-borang-a](../../static/img/faq/textfile-monthly-online-submisson/epf-print-borang-a.png)

3. Click on the "Submission of KWSP’s Borang A via Magnetic Media" (the option is available at the bottom right of the screen).
...
5. Click on **⋯** to select the location that you will be saving this text file into.

   ![epf-saved-file-location](../../static/img/faq/textfile-monthly-online-submisson/epf-saved-file-location.png)

6. For example, save the file to `Desktop`. Once you have selected the location, press "OK".
...
8. Close the pop-up and the generated text file will be in `Desktop`.

   ![epf-result](../../static/img/faq/textfile-monthly-online-submisson/epf-result.png)

9. The text file is now ready for online submission on the KWSP website.

### SOCSO (ASSIST PERKESO)

1. After processed your month end, navigate to **Payroll** > **Government Reports**.

2. Click on "Print SOCSO Borang 8A".

   ![socso-print](../../static/img/faq/textfile-monthly-online-submisson/socso-print.png)

3. Click on "Submission of SOCSO Borang 8A via Magnetic Media".
...
5. Click on **⋯** to select the location that you will be saving this text file into. Then press "OK". Finally click on "Save".

   ![socso-saved-file-location](../../static/img/faq/textfile-monthly-online-submisson/socso-saved-file-location.png)

6. The following shows the text file generated is saved to `Desktop`.

   ![socso-save](../../static/img/faq/textfile-monthly-online-submisson/socso-save.png)

7. The text file is now ready for online submission on the SOCSO official website.
...
7. The text file is now ready for online submission on the LHDN's official website.
...
2. Click on "Print EIS Lampiran 1".

   ![eis-print](../../static/img/faq/textfile-monthly-online-submisson/eis-print.png)

3. Click on "Submission of EIS Lampiran 1 via Magnetic Media".
...
7. The text file is now ready for online submission on the SOCSO's official website.
